...
class Cliente(models.Model):
    ...
    customer_name = models.TextField('Nombre', max_length=255, null=False, blank=False)
    customer_surname = models.TextField('Apellido', max_length=255, null=False, blank=False)
